...
db.exec(`
  ...
  -- (telegramUserbot2.js). Kept as a fully separate table rather than sharing rows —
  -- an access_hash is only valid for the account that resolved it, so the two accounts
  -- must never read each other's cached peers.
